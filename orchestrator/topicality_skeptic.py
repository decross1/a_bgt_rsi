...
_SYSTEM = (
    ...
    "game-theory research apparatus. Attack that judgment. State the "
    "claim's PRIMARY subject and the concrete evidence that would test "
    "it. If that evidence is code-quality / software-engineering / "
    "database / distributed-systems / ML-infrastructure metrics rather "
    "than game-play data among strategic agents, it is OFF-domain even "
    "when phrased with payoffs/equilibria/auctions/cooperation. A claim "
    "substantively about strategic interaction — LLM agents PLAYING "
    "games (PD, auctions, bargaining, beauty contests), in plain, "
    "biological, or ML vocabulary — is ON-domain.\n"
