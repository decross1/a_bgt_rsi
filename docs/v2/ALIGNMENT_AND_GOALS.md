...
| **G1** | **Regenerate** | | |
| G1.1 | Successor generation per `docs/v2/THESIS_BRIEF_2026-09-23.md` (D-086: information and beliefs; 3–5 candidates on local weights, each with mechanism, T/S/A design, falsifier and anomaly map) | N (candidates) + O (screen and selection) | One candidate set produced by Nara, screened and selected by Oracle after independent meta review through G0.2; owner approval is required only for any later live-trading action |
