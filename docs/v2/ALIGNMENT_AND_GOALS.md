...
| **G1** | **Regenerate** | | |
| G1.1 | Successor generation per `docs/v2/THESIS_BRIEF_2026-09-23.md` (D-086: information and beliefs; 3–5 candidates on local weights, each with mechanism, T/S/A design, falsifier and anomaly map) | N (candidates) + O (screen and selection) | One source-bound candidate set produced, screened and ranked by Oracle, its proposed selection reviewed by the meta-oracle, and one eligible focus selected by Oracle through G0.2; the owner is not a selection gate (direct instruction, 2026-09-24) |
