...
**Observed.** This addendum is bound to these repository objects. The first
three are in local `main` commit
`1ea9eef56b2c3af48f840e6922df4c151a5b340b`; the last two are in the D2 notes
commit `9ae60cb43875a4e77f318c917f10ca5972ad44ac`.
...
| D2 machine stop state | `notes/research/2026-09-25-c1-evidence-gate1/STOP_CODE.md` | `9ae60cb` / `26338ced785326355ad5de9f7c8ade63695af0b2` | commit-bound reference |
| D2 full-text route record | `notes/research/2026-09-25-c1-evidence-gate1/FULL_TEXT_ATTEMPT.md` | `9ae60cb` / `751d3982c4d8e688c96e9d32c39b1941dd6bc4c3` | commit-bound reference |
...
This section adds only routes not already resolved by the bound source screen
and D2 `FULL_TEXT_ATTEMPT.md`.
...
2026-03-09. The existing screen's abstract-level findings and D2's HTTP-route
observations remain controlling; this addendum does not restate them as new.

## Gate and eligibility disposition

**Observed.** The D2 gate booleans remain exactly:

```json
{
  "corpus_and_hits_git_reachable": true,
...
- Gate 1 was already true; this note does not alter its corpus.
- Gate 2 remains false. The new negative-route observations did not obtain
  either Garcia manuscript.
- Gate 3 can be substantively advanced by adding the four classified rows
  above, but it cannot truthfully become true: the exact interaction is still
  untested in these sources and the closest Garcia overlap is unresolved.
...
**Inferred disposition.** No scientific-clearance boolean changes. C1 remains
ineligible for focus, T/S/A credit, study registration, or execution under the
bound screen. `insufficient_full_text_binding` remains the truthful stop code.
