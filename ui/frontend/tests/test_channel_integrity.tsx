...
it("initial rows without framing stay unverified",()=>{render(<Channel initial={[row]} initialAvailable={false}/>);expect(screen.getByTestId("channel-turn-unverified")).toHaveTextContent("unverified actor label");});
