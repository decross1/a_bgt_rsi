...
#
# --- STAGED PATCH (a_bgt_rsi) -------------------------------------------------
# Bind-mounted over the container's copy by day1_block2_vllm_serve.
# Source: vllm-project/vllm PR #41745 "[Spec Decode] Add Gemma4 MTP
#   speculative decoding support" (merged into vLLM main).
# Fetched from PR head  lucianommartins/my-vllm
#   @ ce026b01c5f53770b526308b554ed8651857bcc3   (2026-05-18)
# Fixes vs the preview image's bundled gemma4_mtp.py (see DECISIONS.md D-019):
#   - intermediate_size read from text_config, not the top-level config
#   - quant_config no longer propagated to the BF16 drafter Linear layers
# Retire this bind-mount once the pinned vLLM image is rebuilt with the fix.
# -----------------------------------------------------------------------------
